...
import static ru.jonnykea.project.web.user.ProfileController.REST_URL;
import static ru.jonnykea.project.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
import static ru.jonnykea.project.web.user.UserTestData.*;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        USER_MATCHER.assertMatch(userRepository.findAll(), admin, guest, newUser);
    }
